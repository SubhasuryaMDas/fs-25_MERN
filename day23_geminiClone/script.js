const GEONAMES_USERNAME = "akhil04"; // Replace with your GeoNames username
...
async function fetchPlaceSuggestions(query) {
    ...
    try {
        ...
        return data.geonames.map(place => place.name);
    } catch (error) {
...
// Example usage: Autocomplete based on user input
document.addEventListener("DOMContentLoaded", () => {
    const input = document.createElement("input");
    input.setAttribute("type", "text");
    input.setAttribute("placeholder", "Type a letter (e.g., M)...");
